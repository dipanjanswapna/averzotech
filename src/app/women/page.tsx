...
export const metadata: Metadata = {
  title: "Women's Fashion | AVERZO",
  description: 'Explore the latest in women\'s fashion. Shop for dresses, sarees, western wear, accessories, and more.',
};
...
export default function WomenPage() {
    const [content, setContent] = useState<Partial<WomenPageContent>>({});
    ...
    useEffect(() => {
        const fetchWomenPageContent = async () => {
            ...
            if (docSnap.exists()) {
                const data = docSnap.data() as WomenPageContent;
                setContent(data);
                    ...
                    <CarouselItem key={index}>
                        <Link href={image.link || '#'}>
                            <Image
                                ...
                                alt={image.alt || 'Women\'s fashion banner'}
                                width={1200}
                                height={400}
