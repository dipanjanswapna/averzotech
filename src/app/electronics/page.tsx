...
export const metadata: Metadata = {
  title: 'Electronics | AVERZO',
  description: 'Shop for the latest electronics including smartphones, laptops, cameras, and wearables at AVERZO.',
};
...
interface ElectronicsPageContent {
    ...
    const [loading, setLoading] = useState(true);
     ...
     useEffect(() => {
        const fetchElectronicsPageContent = async () => {
            ...
            if (docSnap.exists()) {
                const data = docSnap.data() as ElectronicsPageContent;
                setContent(data);
                    ...
                    <CarouselItem key={index}>
                        <Link href={image.link || '#'}>
                            <Image
                                ...
                                alt={image.alt || 'Electronics Banner'}
                                width={1200}
                                height={400}
