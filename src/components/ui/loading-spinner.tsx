        ...
        <svg height={0} width={0} viewBox="0 0 64 64" className="absolute">
          <defs className="s-xJBuHA073rTt" xmlns="http://www.w3.org/2000/svg">
            <linearGradient className="s-xJBuHA073rTt" gradientUnits="userSpaceOnUse" y2={2} x2={0} y1={62} x1={0} id="b">
              <stop className="s-xJBuHA073rTt" stopColor="hsl(var(--primary))" />
              <stop className="s-xJBuHA073rTt" stopColor="hsl(var(--accent))" offset={1} />
            </linearGradient>
            ...
            <linearGradient className="s-xJBuHA073rTt" gradientUnits="userSpaceOnUse" y2={2} x2={0} y1={62} x1={0} id="d">
              <stop className="s-xJBuHA073rTt" stopColor="hsl(var(--accent))" />
              <stop className="s-xJBuHA073rTt" stopColor="hsl(var(--primary))" offset={1} />
            </linearGradient>
          </defs>
        </svg>
