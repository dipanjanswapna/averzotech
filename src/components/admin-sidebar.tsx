...
import { Home, Users, Package, ShoppingCart, Settings, LogOut, Megaphone, TicketPercent, Gift, LayoutDashboard, Shirt, PersonStanding, ToyBrick, Armchair, Sparkles, Laptop, Trophy, BookOpen, MessageSquarePlus, Annoyed, Store, Truck, Undo2, FileText as VendorInvoiceIcon, BarChart3, Bike, Handshake } from 'lucide-react';
...
export function AdminSidebar({ user }: { user: any }) {
  ...
  const navItems = [
    ...
    { href: '/admin/vendor-applications', label: 'Vendor Applications', icon: Handshake },
  ...
  const shippingItems = [
      ...
      { href: '/delivery/dashboard', label: 'Delivery Dashboard', icon: Bike },
  ]
  ...
  const siteManagementItems = [
      ...
      { href: '/admin/site-management/promo-bar', label: 'Promo Bar', icon: Annoyed },
  ]
                 ...
                 <SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <Link href="/admin/settings/shipping">
                        <SidebarMenuButton 
                            isActive={pathname.startsWith('/admin/settings/shipping')}
                            tooltip={{ children: 'Shipping Settings' }}
                        >
                            <Truck />
                        </SidebarMenuButton>
                    </Link>
